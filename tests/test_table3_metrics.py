...
class Table3MetricsTest(unittest.TestCase):
    ...
    def test_first_k_metrics_are_averaged_across_complete_users(self) -> None:
        events = pd.DataFrame([
            {
                "event_index": 0, "user_id": "a", "label": 0,
                "prediction": 0, "probability": 0.1,
            },
            {
                "event_index": 1, "user_id": "b", "label": 1,
                "prediction": 1, "probability": 0.8,
            },
            {
                "event_index": 2, "user_id": "a", "label": 1,
                "prediction": 1, "probability": 0.9,
            },
            {
                "event_index": 3, "user_id": "b", "label": 1,
                "prediction": 1, "probability": 0.7,
            },
            {
                "event_index": 4, "user_id": "c", "label": 0,
        ...
        self.assertEqual(row["precision_pos"], 1.0)
        self.assertEqual(row["recall_pos"], 1.0)
        self.assertEqual(row["f1_pos"], 1.0)
